...
class drwnOptimizer2 {
 ...
 public:
    ...
    drwnOptimizer2(unsigned n);
    //! copy constructor
    drwnOptimizer2(const drwnOptimizer2& o);
    virtual ~drwnOptimizer2();
 ...
 protected:
	...
	// DEBUG: Files for objective, gradient, and search direction
	//wofstream _debug, _search, _wOutput, _wOutput2;
};
